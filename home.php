        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <a class="nav-link text-dark" href="?url=tulis_catatan">
                        <i class="fas fa-fw fa-pen"></i>
                        <span>Tulis Catatan Perjalanan</span>
                    </a>

                    <a class="nav-link text-dark" href="?url=catatan_perjalanan">
                        <i class="fas fa-fw fa-book"></i>
                        <span>Catatan Perjalanan</span>
                    </a>

                    <a class="nav-link text-dark" href="?url=akun">
                ...
                <div class="container-fluid">
                    ...
                    <div class="h4 mb-4 text-gray-800">
                        ...
                        if(!empty(@$_GET['url'])){
                            ...
                            echo "<h4>Welcome! ".$_SESSION['nama_lengkap']."</h4>";
                        }
                        ?>
                    </div>
